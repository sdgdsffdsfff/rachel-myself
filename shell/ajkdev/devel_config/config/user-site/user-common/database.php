...
$config['cms_user_master']=array(
    'dsn'=>'mysql:host=10.20.3.80;dbname=cms_user',
...
$config['cms_user_slave']=$config['cms_user_master'];
$config['dw_stats_dev']=array(
    'dsn'=>'mysql:host=192.168.1.103;dbname=ajk_dw_stats',
    'username'=>'caixh',
    'password'=>'caixh123',
    'init_attributes'=>array(),
    'init_statements'=>array(
